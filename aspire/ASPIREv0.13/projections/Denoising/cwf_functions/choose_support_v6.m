...
%N=floor(L/2); %debug by wei wang on Dec 13, 2017
%if the img dim is odd number, say 129, then the program is fine;otherwise, would encounter bug
%for example, if dim=128, then dim(-N:N)=129, instead of 128
